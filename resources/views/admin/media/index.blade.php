        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">کتابخانه رسانه</h3>
                    <div class="card-tools">
                        <form action="{{ route('admin.media.upload') }}" method="POST" enctype="multipart/form-data" class="d-inline" id="upload-form">
                            @csrf
                            ...
                            <ol class="breadcrumb">
                                ...
                                @if($path)
                                    ...
                                    @foreach($paths as $folder)
                                        ...
                                        @endphp
                                        <li class="breadcrumb-item">
                                            <a href="{{ route('admin.media.index', ['path' => rtrim($currentPath, '/')]) }}">
                                                {{ $folder }}
                                            </a>
                                        </li>
                                    @endforeach
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            @else
                                                @if(in_array($item['extension'], ['jpg', 'jpeg', 'png', 'gif']))
                                                    <img src="{{ asset('storage/' . $path . '/' . $item['name']) }}" class="img-fluid mb-2" style="max-height: 100px;">
                                                ...
                                                <button class="btn btn-sm btn-info copy-link" data-url="{{ $item['name'] }}">
