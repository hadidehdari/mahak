        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">افزودن ویدیو جدید</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.videos.index') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mt-2">
                                <img src="{{ old('thumbnail') ? asset('storage/' . old('thumbnail')) : asset('images/no-image.png') }}" 
                                     alt="تصویر بندانگشتی" 
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control @error('video_url') is-invalid @enderror" id="video_url" name="video_url" value="{{ old('video_url') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('file_size') is-invalid @enderror" id="file_size" name="file_size" value="{{ old('file_size') }}" placeholder="مثال: 1.2GB">
                            @error('file_size')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('rating') is-invalid @enderror" id="rating" name="rating" value="{{ old('rating', 0) }}" min="0" max="5" step="0.1">
                            @error('rating')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('rating_count') is-invalid @enderror" id="rating_count" name="rating_count" value="{{ old('rating_count', 0) }}" min="0">
                            @error('rating_count')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
